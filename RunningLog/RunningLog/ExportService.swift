...
class ExportService: ObservableObject {
    ...
    private func fetchLogs(options: ExportOptions) async throws -> [HistoryLogEntry] {
    ...
    private func generateCSV(logs: [HistoryLogEntry], options: ExportOptions) throws -> URL {
