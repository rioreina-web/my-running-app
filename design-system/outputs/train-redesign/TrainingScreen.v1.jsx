...
const TrainingScreen = ({ onOpenDay, onOpenPlan, onOpenWorkout, onOpenRace }) => (
  <div className="page">
    ...
    <div className="page__body">
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginTop: 14 }}>
        ...
        <span className="link" onClick={onOpenRace} style={{ marginLeft: "auto", fontSize: 12, cursor: "pointer" }}>Race plan ↗</span>
      </div>
      ...
      <Section eyebrow="COACH'S PLAN · WEEK 09" eyebrowRight={<span onClick={onOpenPlan} style={{ cursor: "pointer" }}>VIEW PLAN ↗</span>}>
      ...
      {/* Recent log */}
      <Section eyebrow="TRAINING LOG · RECENT" eyebrowRight={<span onClick={onOpenWorkout} style={{ cursor: "pointer" }}>VIEW ALL ↗</span>}>
        {RECENT_LOGS.map((l, i) => (
          <div key={i} onClick={onOpenWorkout} style={{ padding: "12px 0", borderBottom: i < RECENT_LOGS.length - 1 ? "1px solid var(--rule)" : "0", cursor: "pointer" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
