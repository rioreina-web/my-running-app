...
const SignInScreen = ({ onSignIn, onCreateAccount }) => {
      ...
      <div className="signin-shell">
        ...
        <div className="signin-form">
          ...
          <div style={{ textAlign: "center", marginTop: 4 }}>
            <a className="link" style={{ fontSize: 12, color: "var(--ink-2)", borderColor: "var(--rule)", cursor: "pointer" }} onClick={onCreateAccount}>Create account</a>
          </div>
        </div>
      </div>
    </div>
